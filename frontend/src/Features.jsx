                ...
                <div className="grid lg:grid-cols-2 gap-8">
                    ...
                    <span className="mt-1 w-4 h-4 rounded-full bg-[#c8a84b]/20 flex items-center justify-center flex-shrink-0">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#c8a84b]" />
                            ...
                            <button className="mt-7 w-full py-3 rounded-xl border border-[#c8a84b]/40 text-[#c8a84b] hover:bg-[#c8a84b] hover:text-[#0f1a0f] transition-all duration-200 text-sm">
                                Browse Rentals
                            </button>
                        </div>
                    </div>
                    ...
                    <span className="mt-1 w-4 h-4 rounded-full bg-[#c8a84b]/20 flex items-center justify-center flex-shrink-0">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#c8a84b]" />
                            ...
                            <button className="mt-7 w-full py-3 rounded-xl bg-[#c8a84b] text-[#0f1a0f] hover:bg-[#dbbe60] transition-all duration-200 text-sm shadow-lg shadow-[#c8a84b]/20">
                                Book a Table
                            </button>
                        </div>
                    </div>
