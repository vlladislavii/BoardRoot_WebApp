            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-16 items-center w-full">
              ...
              Now Open — Join the Club
                    ...
                    <div className="flex flex-wrap gap-4 mb-12">
                        <button className="flex items-center gap-2 px-7 py-3.5 rounded-xl bg-[#c8a84b] text-[#0f1a0f] hover:bg-[#dbbe60] transition-all shadow-xl shadow-[#c8a84b]/25 group">
                            Browse Catalog
                            <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                        </button>
                        <button className="flex items-center gap-2 px-7 py-3.5 rounded-xl border border-[#2a4a2a] text-white hover:border-[#4a7a4a] hover:bg-[#1a2e1a] transition-all group">
                ...
                <div className="hidden lg:block relative">
                    <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-black/60 border border-[#2a4a2a]">
                        ...
                        <div className="absolute bottom-5 left-5 right-5 flex items-center justify-between gap-3">
                            ...
                            <div className="bg-[#c8a84b] rounded-xl px-4 py-3 text-[#0f1a0f] text-xs whitespace-nowrap" style={{ fontWeight: 700 }}>
                                Reserve
                            </div>
                        </div>
                    </div>
