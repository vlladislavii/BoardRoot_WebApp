            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="mt-20 text-center">
                    <p className="text-[#6a8a6a] mb-6">
                        Join 2,000+ members already playing smarter.
                    </p>
                    <button className="px-10 py-4 rounded-xl bg-[#c8a84b] text-[#0f1a0f] hover:bg-[#dbbe60] transition-all shadow-xl shadow-[#c8a84b]/25 text-sm">
                        Create Free Account
                    </button>
                </div>
            </div>
