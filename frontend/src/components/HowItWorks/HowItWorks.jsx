                    ...
                    >
                        ...
                        <div className="flex gap-3 flex-shrink-0">
                            <button
                                ...
                                className="px-6 py-3 rounded-xl border border-[#c8a84b]/40 text-[#c8a84b] hover:bg-[#c8a84b]/10 transition-all text-sm"
                            >
                                View Catalog
                            </button>
                            <button
                                onClick={handleJoinFree}
                                className="px-6 py-3 rounded-xl bg-[#c8a84b] text-[#0f1a0f] hover:bg-[#dbbe60] transition-all text-sm shadow-lg shadow-[#c8a84b]/20"
                            >
                                Join Free
                            </button>
                        </div>
